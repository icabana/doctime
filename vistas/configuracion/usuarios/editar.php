        ...
        <div style="padding: 25px" class="col-md-6">
          ...
          <div class="card card-primary">
            ...
            <form role="form">
              ...
              <input type="hidden" class="form-control" id="id_usuario" name="id_usuario" value="<?php echo $datos['id_usuario']; ?>">

              <div class="card-body">
                <div class="form-group">
                  <label>Nick</label>

                  <input type="text" class="form-control" id="nick_usuario" name="nick_usuario" value="<?php echo $datos['nick_usuario']; ?>">

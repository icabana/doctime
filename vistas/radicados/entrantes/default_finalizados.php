<script type="text/javascript">
    ...
    function nuevo_entrante() {
        ...
        abrirVentanaContenedor(
            'radicados', 'Entrantes', 'nuevo_finalizados', '', ''
        );
  ...
  mensaje_alertas("success", "Ajuste Exitoso", "center");
    ...
    function eliminar_entrante2() {
        ...
        ejecutarAccion(
            ...
            'eliminar',
            "radicados=" + radicados,
            ' mensaje_alertas("success", "Eliminados con Éxito", "center"); cargar_entrantes_finalizados();'
        );
        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Radicados Finalizados</h3>
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <button title="Actualizar Lista de Radicados" onclick="cargar_entrantes_finalizados();" type="button" class="btn btn-default btn-sm"><i class="fas fa-sync-alt"></i></button>

...
ejecutarAccion(
    ...
    'eliminar',
    "radicados=" + $("#id_entrante").val(),
    ' mensaje_alertas("success", "Carpeta Eliminada con Éxito", "center"); cargar_entrantes_archivados();'
);
    ...
    <div class="card card-primary">
      ...
      <input type="hidden" id="numero_entrante2" name="numero_entrante2" value="<?php echo $datos['numero_entrante']; ?>">
        ...
        <div class="card-body">
          ...
          <button onclick="cargar_entrantes_archivados();" class="btn btn-danger">Cancelar</button>

<?php
    ...
    mkdir('../../archivos/uploads/entrantes/'.$_POST['id_entrante'].'/'.$_POST['documento_soporte']);

    $carpeta = '../../archivos/uploads/entrantes/'.$_POST['id_entrante'].'/'.$_POST['documento_soporte'].'/';

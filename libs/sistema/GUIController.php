...
class GUIController
{
    ...
    static function main()
    {
        ...
        require 'libs/pdf/PdfReporteEmpleados.php'; //de Reportes
        require 'libs/pdf/PdfReporteTerceros.php'; //de Reportes
        require 'libs/pdf/PdfReporteDependencias.php'; //de Reportes

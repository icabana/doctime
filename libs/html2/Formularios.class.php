...
class Formularios{
	...
	public function Lista_Desplegable_TODOS($datos, $campoTexto, $campoValor, $id_lista, $option = '00', $onclick = '', $onchange = '', $estilo = '', $multiple = false, $textoDefecto='[SELECCIONE UNO]'){
        
        $Lista = new ListaDesplegable();
            
        return $Lista->crear_TODOS(
            $datos, $campoTexto, $campoValor, 
            $id_lista, $option, 
            $onclick, $onchange, 
            $estilo, $multiple,$textoDefecto

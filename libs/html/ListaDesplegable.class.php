...
//		$opciones = $this->opcion_lista_desplegable( $this->textoDefecto, $this->valorDefecto,  $option);
	...
	public function crear_TODOS($datos, $campoTexto, $campoValor, $id_lista, $option = '00', $onclick = '', $onchange = '', $estilo = '', $multiple = false, $textoDefecto){
    ...
    if(count($datos)==0){
      ...
      $this->html_abre_lista_desplegable .= "<option value='TODOS'>TODOS</option>";
  }

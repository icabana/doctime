...
(function($){
  jQuery.fn.buildContainers = function (options){
    return this.each (function (){
	  ...
	  container.attr("dock","estado_dock_ventanas");
  ...
  jQuery.fn.containerSetIcon = function (icon,path){
    var container=$(this);
    if (icon && icon!="" ){
      container.find(".ne:first").prepend("<img class='icon' src='"+path+"iconos/"+icon+"' style='position:absolute; width:48px;'/>");
  ...
  jQuery.fn.containerSetButtons = function (buttons,opt){
    ...
    if (buttons !=""){
      ...
      for (var i in btn){
        if (btn[i]=="c"){
          container.find(".buttonBar:first").append("<img src='"+path+"ventanas/"+container.attr('skin')+"/close.png' class='close'/>");
          container.find(".close:first").bind("click",function(){
            container.mb_close();
          });
        }
        if (btn[i]=="m"){
          container.find(".buttonBar:first").append("<img src='"+path+"ventanas/"+container.attr('skin')+"/min.png' class='collapsedContainer'/>");
        ...
        if (btn[i]=="p"){
          container.find(".buttonBar:first").append("<img src='"+path+"ventanas/"+container.attr('skin')+"/print.png' class='printContainer'/>");
          container.find(".printContainer:first").bind("click",function(){});
        }
        if (btn[i]=="i"){
          container.find(".buttonBar:first").append("<img src='"+path+"ventanas/"+container.attr('skin')+"/iconize.png' class='iconizeContainer'/>");
  ...
  jQuery.fn.containerCollapse = function (opt){
    this.each (function () {
      ...
      if (!container.mb_getState("collapsed")){
        ...
        container.find(".collapsedContainer:first").attr("src",opt.elementsPath+"ventanas/"+container.attr('skin')+"/max.png");
        ...
        container.attr("collapsed","false");
        container.find(".collapsedContainer:first").attr("src",opt.elementsPath+"ventanas/"+container.attr('skin')+"/min.png");
  ...
  jQuery.fn.containerIconize = function (opt,runCallback){
    ...
    return this.each (function (){
      ...
      /*
       ICONIZING CONTAINER
       */
      this.dockIcon= $("<img src='"+opt.elementsPath+"iconos/"+(container.attr("icon")?container.attr("icon"):"restore.png")+"' class='restoreContainer' width='"+opt.dockedIconDim+"'/>").appendTo(dockPlace)
              .css("cursor","pointer")
              .hide()

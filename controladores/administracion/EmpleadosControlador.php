...
class EmpleadosControlador extends ControllerBase {
    ...
    public function index_usuario() {
        ...
        $this->model->cargar("EmpleadosModel.php", "administracion");
        $EmpleadosModel = new EmpleadosModel();     
        $datos = $EmpleadosModel->getDatos($_SESSION['id_empleado']);
            
        $this->model->cargar("UsuariosModel.php", "configuracion");
        $UsuariosModel = new UsuariosModel();     
        $datos_usuario = $UsuariosModel->getDatos($_SESSION['id_empleado']);

        include 'vistas/administracion/empleados/editar_usuario.php';
